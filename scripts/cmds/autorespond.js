module.exports = {
  ...
  onChat: async ({ api, event }) => {
    ...
    const emojis = {
      ...
      "🌭": ["🔥", ".jpg", "astig", "damn", "angas", "galing", "husay"],
      "🍕": ["merde", "Merde", "caca", "Caca", "shit"],
      "🥦": ["beurk", "dégueulasse", "dégeu", "horrible"],
      "🍰": ["amour", "câlin", "tendresse", "gentillesse", "bienveillance", "douceur", "complicité", "gratitude", "bonheur", "amitié"],
      "🍭": ["Ridicule", "Clownesque", "Farce", "Pitrerie", "Comique", "Drôle", "Amusant", "Hilarant", "Loufoque", "Bouffonnerie", "Cocasse", "Burlesque", "Rigolo", "Absurde", "Irrévérencieux", "Ironique", "Ironie", "Parodie", "Esprit", "Facétieux"],
      "🍹": ["cool", "formidable"],
      "🥖": ["Super", "Aesther"],
      "🍣": ["Prefix", "robot"],
      "🍦": ["Nathan", "barro"],
