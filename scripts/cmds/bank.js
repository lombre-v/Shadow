...
module.exports = {
  ...
  await api.sendMessage(recipientMessage, recipientUID);
      ...
      case "top":
        ...
        return message.reply("𝐑𝐢𝐜𝐡𝐞𝐬𝐭 𝐩𝐞𝐨𝐩𝐥𝐞 𝐢𝐧 𝐭𝐡𝐞 𝐒𝐇𝐀𝐃𝐎𝐖 𝐬𝐲𝐬𝐭𝐞𝐦👑🤴:\n" + output);
